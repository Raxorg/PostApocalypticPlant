...
public class SharedConstants {
    ...
    public static final Color WHITE_CLEAR_50 = Color.WHITE.cpy().lerp(Color.CLEAR, 0.50f);

    public static final Color BLACK_CLEAR_25 = Color.BLACK.cpy().lerp(Color.CLEAR, 0.25f);
    public static final Color BLACK_CLEAR_50 = Color.BLACK.cpy().lerp(Color.CLEAR, 0.50f);
